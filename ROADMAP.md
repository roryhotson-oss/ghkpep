...
- [x] **CI placeholder checks** — done 2026-09-07: Test & Lint and Security Audit now ignore intentional placeholders in `.env.example` while continuing to scan source and tracked non-example environment files; CI now uses Node 22 to match the package engine.
