...
- [x] **Fix GitHub Actions security audit** — done 2026-09-07: the placeholder scan now ignores the documented `.env.example` template and source fallback checks, scans only tracked non-example environment files, and CI uses Node 22 to match the package engine.
