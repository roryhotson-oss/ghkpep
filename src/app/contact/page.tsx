            ...
            <div className="bg-[#141414] rounded-xl p-6 border border-[#222]">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <span className="text-[#00d4aa]">Contact us via the form or checkout options</span>
                </div>
                <div>
                  <span className="text-[#888] block">Response Time</span>
                  <span className="text-[#ccc]">Within 24 hours</span>
                </div>
                <div>
          ...
          <div className="lg:col-span-2">
            {status === 'success' ? (
              <div className="bg-[#141414] rounded-xl p-8 border border-[#222] text-center">
                ...
                <p className="text-[#888] mb-6">Thank you for contacting us. We&apos;ll get back to you within 24 hours.</p>
                <button
                  onClick={() => setStatus('idle')}
                  className="px-6 py-3 bg-[#00d4aa] text-black font-semibold rounded-lg hover:bg-[#00b894] transition"
                >
                  Send Another Message
                </button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="bg-[#141414] rounded-xl p-6 sm:p-8 border border-[#222] space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#1a1a1a] border border-[#222] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#00d4aa]"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#1a1a1a] border border-[#222] rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#00d4aa] resize-none"
                ...
                <button
                  ...
                  className="w-full px-8 py-3 bg-[#00d4aa] text-black font-semibold rounded-lg hover:bg-[#00b894] transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
