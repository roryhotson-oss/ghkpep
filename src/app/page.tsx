      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 border border-[#cbdbe6] bg-white px-5 py-5 sm:px-6">
            ...
            <h2 className="mt-2 text-xl font-bold text-[#10263d]">Have a question or interested in a product?</h2>
            <p className="mt-2 text-[#425b6d]">
              Email our team and tell us which product you are asking about. We will reply when a member of the team is available.
            </p>
            <Link
