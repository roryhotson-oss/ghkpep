          ...
          {filteredProducts.map((entry) => {
            if (isProductGroup(entry)) {
              ...
              return (
                <div
                  key={entry.key}
                  className="group flex flex-col text-[#34414a] bg-[#fbfaf7] rounded-2xl p-4 border border-[#d8d4c9] shadow-[0_8px_20px_rgba(52,65,74,0.06)] hover:-translate-y-1 hover:shadow-[0_14px_28px_rgba(52,65,74,0.12)] transition"
                >
