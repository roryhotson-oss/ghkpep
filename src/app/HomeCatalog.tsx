    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <header className="mb-8">
        <div className="flex flex-wrap items-center gap-3 mb-2">
          <p className="text-[#21c7a5] text-sm font-medium">GHKpep</p>
          <a href="https://uk-rscs.org" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-2.5 py-1 bg-[#0a2a22] border border-[#21c7a5]/40 rounded-full text-[#21c7a5] text-[10px] font-bold tracking-wide hover:bg-[#21c7a5] hover:text-black transition">
            <span className="w-1.5 h-1.5 rounded-full bg-current" />
            AUDITED · UK-RSCS.ORG
          </a>
        </div>
        <h1 className="text-3xl sm:text-4xl font-bold">Research compounds.</h1>
        <p className="text-[#a7b0b2] mt-3">No noise. Just documented research compounds and lab accessories.</p>
      </header>
