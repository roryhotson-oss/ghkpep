    ...
    <div>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-[#141414] rounded-xl p-6 border border-[#222]">
          ...
          <p className="text-[#888] text-sm mb-4">Contact us via WhatsApp, Telegram, or Email from the checkout page to file a claim.</p>
          <Link href="/cart" className="inline-block px-6 py-3 bg-[#00d4aa] text-black font-semibold rounded-lg hover:bg-[#00b894] transition text-sm">
            Go to Checkout
          </Link>
        </div>
      </section>
