          ...
          <div>
            <div className="bg-white rounded-2xl p-6 border border-[#d7e3eb] sticky top-24 shadow-sm">
              ...
              <div className="mt-4 space-y-2">
                ...
                <a
                  href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'support@ghkpep.com'}?subject=${encodeURIComponent('Order Enquiry from GHKpep.com')}`}
                ...
                <p className="text-center text-xs text-[#607789] pt-1">Not sure which payment method to use? Message us on WhatsApp and we'll help you find the best route for payment.</p>
              </div>
