                ...
                <div className="space-y-2">
                  ...
                  <div className={`p-3 rounded-lg border transition ${selectedPaymentMethod === 'alipay' ? 'border-[#139fe8] bg-[#e8f6fd]' : 'border-[#d7e3eb] bg-[#f3f7fa]'}`}>
                    ...
                    {selectedPaymentMethod === 'alipay' && <div className="mt-3 pl-8">
                      ...
                      {paymentSettings.alipayQrUrl ? <img src={paymentSettings.alipayQrUrl} alt="Alipay payment QR code" className="mt-4 w-44 h-44 object-contain rounded-lg border border-[#d7e3eb] bg-white p-2" /> : <p className="mt-3 text-xs text-[#b06a00]">Alipay QR code will appear here once it is added in Payment Settings.</p>}
