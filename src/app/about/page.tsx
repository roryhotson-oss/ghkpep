    ...
    <div>
      <section className="text-[#34414a] bg-[#dceff7] rounded-3xl border border-[#c8dfe7] shadow-[0_10px_24px_rgba(52,65,74,0.08)] max-w-7xl mx-4 sm:mx-6 xl:mx-auto mt-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <p className="text-[#0c1622] text-sm font-medium mb-2">Our story</p>
          <h1 className="text-3xl font-bold text-[#0c1622]">A new standard for the lab.</h1>
          <p className="text-[#0c1622] mt-3 max-w-2xl">GHK exists because reference-grade research compounds shouldn&apos;t require a leap of faith. We built the supplier we wished we had.</p>
        </div>
      </section>

      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose max-w-none">
          <p className="text-[#0c1622] text-lg leading-relaxed">
          ...
          <p className="text-[#0c1622] mt-6 leading-relaxed">
          ...
          <p className="text-[#0c1622] mt-4 leading-relaxed">
      ...
      <section className="text-[#34414a] bg-[#dceff7] rounded-3xl border border-[#c8dfe7] shadow-[0_10px_24px_rgba(52,65,74,0.08)] max-w-7xl mx-4 sm:mx-6 xl:mx-auto mt-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <h2 className="text-2xl font-bold mb-10 text-center text-[#0c1622]">Six principles, written down.</h2>
      ...
      <section className="text-[#34414a] bg-[#dceff7] rounded-3xl border border-[#c8dfe7] shadow-[0_10px_24px_rgba(52,65,74,0.08)] max-w-7xl mx-4 sm:mx-6 xl:mx-auto mt-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <h2 className="text-2xl font-bold mb-4 text-[#0c1622]">Built for the bench. Verified for your peace of mind.</h2>
          <p className="text-[#0c1622] mb-6">Browse the catalog, read a COA, or talk to our team. We respond to researcher questions within one business day.</p>
          <div className="flex gap-4 justify-center">
            ...
            <Link href="/contact" className="px-6 py-3 border border-[#0c1622]/40 text-[#0c1622] font-semibold rounded-lg hover:border-[#0c1622] hover:bg-[#0c1622]/5 transition">Contact the team</Link>
          </div>
        </div>
      </section>
    </div>
